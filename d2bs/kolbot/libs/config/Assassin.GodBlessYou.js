...
function LoadConfig() {
	...
	*/
	...
	Config.AttackSkill[2] = 276; // Primary untimed skill to bosses. Keep at -1 if Config.AttackSkill[1] is untimed skill.
	Config.AttackSkill[3] = 271; // Primary skill to others.
	Config.AttackSkill[4] = 276; // Primary untimed skill to others. Keep at -1 if Config.AttackSkill[3] is untimed skill.
	Config.AttackSkill[5] = 271; // Secondary skill if monster is immune to primary.
	Config.AttackSkill[6] = 276; // Secondary untimed skill if monster is immune to primary untimed.
